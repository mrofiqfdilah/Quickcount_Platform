...
<body>
    ...
    <div class="content">
        ...
        data-aos-offset="300"
        data-aos-easing="ease-in-sine" style="width: 990px; margin-left:275px;">
            <div class="card-body">
                <a href="{{ route('admin.create') }}" style="background-color:#0D6EFD;  color:#fff;" class="btn  mb-3">Tambah Data</a>
                <table>
                    <tr>
                        <th style="border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">Nama Relawan</div></th>
                        <th style="border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">Email</div></th>
                        <th style="border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">No Telpon</div></th>
                        <th style="border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">Asal Kabupaten</div></th>
                    ...
                    <tr>
                        <td style="border: 1px solid #ddd; text-align:center; padding: 8px; ">{{ $user->name }}</td>
                        <td style="border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">{{ $user->email }}</td></div>
                        <td style="border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center"><a href="" style="text-decoration: none;">{{ $user->notelpon }}</a></td></div>
                        <td style="border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">{{ $user->kabupaten }}</td></div>
                        <td style="border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">{{  $user->tps->notps }}</td></div>     
                        <td style="border: 1px solid #ddd; padding: 8px;">
                            <div class="d-flex justify-content-center"> <!-- Edit button -->
                                <a href="{{ route('admin.edit', $user->id) }}" class="btn btn-primary">Edit</a>
                                <!-- Delete button -->
                                <form action="{{ route('admin.destroy', $user->id) }}" method="post" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                    @csrf
                                    @method('DELETE')
